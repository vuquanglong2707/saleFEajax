...
$datas = 1;
$data_cato = "all";
if(isset($_GET["page"])) $datas = $_GET["page"];
if(isset($_GET["catogories"])) $data_cato = $_GET["catogories"];
// echo $datas;
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>Giao hàng đồng giá 50.000 VND trên toàn quốc</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar" style="border:1px solid #fdd6d6; background:#fdd6d6;">
                        <div class="sidebar__item">
                            <h4 style="text-align:center;">Loại sản phẩm</h4>
                            <ul class="catogories" style="padding-left:10px;">
                            ...
                            <div class="product__discount__slider owl-carousel">
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Hoa quả sấy khô</span>
                                            <h5><a href="shop-details.php">Hoa quả sấy</a></h5>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Rau</span>
                                            <h5><a href="shop-details.php">Rau củ quả tươi</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Hoa quả sấy khô</span>
                                            <h5><a href="shop-details.php">Trái cây hỗn hợp</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="shop-details.php">Xoài</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="shop-details.php">Humburger</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Hoa quả tươi</span>
                                            <h5><a href="shop-details.php">Nho mỹ</a></h5>
                                            <div class="product__item__price">$30.00 <span>$36.00</span></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        var data_catos = "<?=$data_cato?>"; 
        console.log(data_catos)
    </script>
    <!-- Js Plugins -->
    <script src="js/jquery-3.5.1.min.js"></script>
    <script src="js/bootstrap.min.js"></script>
    <script src="js/apiProduct.js?v=<?=time()?>"></script>
